  ...
  <div class="container">
    <div class="row trend_1" style="display:flex; justify-content: space-between;">
      ...
      <div class="col-md-6 col-6 text-end">
        <h6 class="mb-0">
          <router-link to="/movie/now" class="btn btn-primary" style="text-decoration: none;">View All</router-link>
        </h6>
      </div>
    </div>
...
<script>
import LatestListItem from '@/components/HomeMovieComponents/LatestListItem'
...
<style>
.hr-line {
  border: 1px solid rgba(227, 9, 232, 0.5);
  padding: 0;
  width: 98%;
  margin: 0 auto;
  margin-bottom: 20px;
